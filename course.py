...
class CourseClass:
    def __init__(self, root):
        ...
        # === Search Panel ===
        lbl_search_courseName = Label(self.root, text="Search By Name", font=("goudy old style", 15, 'bold'), bg='white').place(x=720, y=60)
    ...
    def delete(self):
        ...
        try:
            if self.var_course.get() == "":
                ...
                row = cur.fetchone()
                if row == None:
                    messagebox.showerror("Error", "Select Course from the list")
                else:
